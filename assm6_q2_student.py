...
def confidence_interval(N_samples=40, sample_size=30, true_mean=3, true_std=0.67, confidence=0.95):
    """
    ...
    for i in range(N_samples):
        ...
        sample_se =  np.std(sample, ddof=1) / np.sqrt(sample_size)   # SE = s/√n
